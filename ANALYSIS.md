...
strict-concurrency migration remain open. `SionCore` and its tests use Swift 6
language mode; the AppKit targets still inherit Swift 5 mode under the Swift
6.3.3 toolchain. Save As now keeps the native display name and archived title
synchronized without dirtying the document.
