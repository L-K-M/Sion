  ...
  private enum SionMainMenu {
    ...
    private static func fileMenu(
      ...
      submenu.addItem(
        item("New", action: #selector(NSDocumentController.newDocument(_:)), key: "n"))
    ...
    private static func viewMenu() -> NSMenuItem {
      ...
      submenu.addItem(item("Snap to Objects", action: AppAction.toggleObjectSnapping))
      submenu.addItem(.separator())
      submenu.addItem(
        item(
          "Inspector", action: AppAction.showInspector, key: "i", modifiers: [.command, .option]))
      submenu.addItem(
